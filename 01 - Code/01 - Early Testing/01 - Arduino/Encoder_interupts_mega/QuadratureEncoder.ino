...
int E1_phaseApin = A12;
int E1_phaseBpin = A11;
int E2_phaseApin = A10;
int E2_phaseBpin = A9;
...
void initialiseEncoders(){
  ...
  enableInterrupt(E2_phaseApin, E2_phaseAISR, CHANGE);
  enableInterrupt(E2_phaseBpin, E2_phaseBISR, CHANGE);
}
