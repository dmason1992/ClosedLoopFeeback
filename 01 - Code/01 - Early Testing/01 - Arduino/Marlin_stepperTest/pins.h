...
// #define RAMPS_V_1_0
  ...
  #define LARGE_FLASH true
    ...
    #define FAN_PIN            -1 // FAN PIN (put on aux - needs to be built into dual extruder head)
  #endif
...
//x axis pins
    ...
    #define TEMP_0_PIN      3     //changed @ rkoeppl 20110410
...
#define TEMP_0_PIN          3   // MUST USE ANALOG INPUT NUMBERING NOT DIGITAL OUTPUT NUMBERING!!!!!!!!! (pin 33 extruder)
#define TEMP_1_PIN         -1
#define TEMP_2_PIN         -1
...
#define KILL_PIN           46
 ...
 #if (TEMP_SENSOR_0==-1)
  #define TEMP_0_PIN         3    // ANALOG NUMBERING - connector *K1* on RUMBA thermocouple ADD ON is used
 #else
  #define TEMP_0_PIN         3   // ANALOG NUMBERING - default connector for thermistor *T0* on rumba board is used
 #endif
#endif
...
#define TEMP_0_PIN          3 //D27   // MUST USE ANALOG INPUT NUMBERING NOT DIGITAL OUTPUT NUMBERING!!!!!!!!!
...
#define HEATER_1_PIN       -1
#define HEATER_2_PIN       -1
#define TEMP_0_PIN          3 // ANALOG INPUT NUMBERING
